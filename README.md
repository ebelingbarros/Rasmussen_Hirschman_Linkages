...
- The chief objective of this project was to train and test my abilities using Python. I decided to pursue around two weeks after the Data Analytics Bootcamp had started, and used time in between classes and labs to code. 
